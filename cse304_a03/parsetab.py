...
=======
  ('program -> class_decl','program',1,'p_program','decaf_parser.py',37),
  ('program -> empty','program',1,'p_program','decaf_parser.py',38),
  ('class_decl -> class_decl class_decl','class_decl',2,'p_program','decaf_parser.py',39),
  ('class_decl -> CLASS ID EXTENDS ID { class_body_decl }','class_decl',7,'p_class_decl','decaf_parser.py',44),
  ('class_decl -> CLASS ID { class_body_decl }','class_decl',5,'p_class_decl','decaf_parser.py',45),
  ('class_body_decl -> class_body_decl class_body_decl','class_body_decl',2,'p_class_body_decl','decaf_parser.py',91),
  ('class_body_decl -> field_decl','class_body_decl',1,'p_class_body_decl','decaf_parser.py',92),
  ('class_body_decl -> method_decl','class_body_decl',1,'p_class_body_decl','decaf_parser.py',93),
  ('class_body_decl -> constructor_decl','class_body_decl',1,'p_class_body_decl','decaf_parser.py',94),
  ...
  ('modifier -> PRIVATE STATIC','modifier',2,'p_modifier','decaf_parser.py',108),
  ('modifier -> PRIVATE','modifier',1,'p_modifier','decaf_parser.py',109),
  ('modifier -> PUBLIC STATIC','modifier',2,'p_modifier','decaf_parser.py',110),
  ('modifier -> PUBLIC','modifier',1,'p_modifier','decaf_parser.py',111),
  ('modifier -> STATIC','modifier',1,'p_modifier','decaf_parser.py',112),
  ('modifier -> empty','modifier',1,'p_modifier','decaf_parser.py',113),
  ('var_decl -> type variables ;','var_decl',3,'p_var_decl','decaf_parser.py',117),
  ('variables -> variable','variables',1,'p_variables','decaf_parser.py',121),
  ('variables -> variable , variables','variables',3,'p_variables','decaf_parser.py',122),
  ('variable -> ID','variable',1,'p_variable','decaf_parser.py',129),
  ('field_decl -> modifier var_decl','field_decl',2,'p_field_decl','decaf_parser.py',134),
  ('method_decl -> modifier type ID ( optional_formals ) block','method_decl',7,'p_method_decl','decaf_parser.py',162),
  ('method_decl -> modifier VOID ID ( optional_formals ) block','method_decl',7,'p_method_decl','decaf_parser.py',163),
  ('optional_formals -> formals','optional_formals',1,'p_optional_formals','decaf_parser.py',193),
  ('optional_formals -> empty','optional_formals',1,'p_optional_formals','decaf_parser.py',194),
  ('formals -> formal_param','formals',1,'p_formals','decaf_parser.py',201),
  ('formals -> formal_param , formals','formals',3,'p_formals','decaf_parser.py',202),
  ('formal_param -> type variable','formal_param',2,'p_formal_param','decaf_parser.py',209),
  ('constructor_decl -> modifier ID ( optional_formals ) block','constructor_decl',6,'p_constructor_decl','decaf_parser.py',216),
  ('block -> { optional_stmts }','block',3,'p_block','decaf_parser.py',235),
  ('block -> { }','block',2,'p_block','decaf_parser.py',236),
  ('optional_stmts -> stmt optional_stmts','optional_stmts',2,'p_optional_stmts','decaf_parser.py',240),
  ('optional_stmts -> empty','optional_stmts',1,'p_optional_stmts','decaf_parser.py',241),
  ('stmt -> IF ( expr ) stmt ELSE stmt','stmt',7,'p_statements','decaf_parser.py',244),
  ('stmt -> IF ( expr ) stmt','stmt',5,'p_statements','decaf_parser.py',245),
  ('stmt -> WHILE ( expr ) stmt','stmt',5,'p_statements','decaf_parser.py',246),
  ('stmt -> FOR ( optional_stmt_expr ; optional_expr ; optional_stmt_expr ) stmt','stmt',9,'p_statements','decaf_parser.py',247),
  ('stmt -> RETURN optional_expr ;','stmt',3,'p_statements','decaf_parser.py',248),
  ('stmt -> stmt_expr ;','stmt',2,'p_statements','decaf_parser.py',249),
  ('stmt -> BREAK ;','stmt',2,'p_statements','decaf_parser.py',250),
  ('stmt -> CONTINUE ;','stmt',2,'p_statements','decaf_parser.py',251),
  ('stmt -> block','stmt',1,'p_statements','decaf_parser.py',252),
  ('stmt -> var_decl','stmt',1,'p_statements','decaf_parser.py',253),
  ('stmt -> ;','stmt',1,'p_statements','decaf_parser.py',254),
  ('optional_expr -> expr','optional_expr',1,'p_statements','decaf_parser.py',255),
  ('optional_expr -> empty','optional_expr',1,'p_statements','decaf_parser.py',256),
  ('optional_stmt_expr -> stmt_expr','optional_stmt_expr',1,'p_statements','decaf_parser.py',257),
  ('optional_stmt_expr -> empty','optional_stmt_expr',1,'p_statements','decaf_parser.py',258),
  ('literal -> INT_CONST','literal',1,'p_expressions','decaf_parser.py',304),
  ('literal -> FLOAT_CONST','literal',1,'p_expressions','decaf_parser.py',305),
  ('literal -> STRING_CONST','literal',1,'p_expressions','decaf_parser.py',306),
  ('literal -> NULL','literal',1,'p_expressions','decaf_parser.py',307),
  ('literal -> TRUE','literal',1,'p_expressions','decaf_parser.py',308),
  ('literal -> FALSE','literal',1,'p_expressions','decaf_parser.py',309),
  ('primary -> literal','primary',1,'p_expressions','decaf_parser.py',310),
  ('primary -> THIS','primary',1,'p_expressions','decaf_parser.py',311),
  ('primary -> SUPER','primary',1,'p_expressions','decaf_parser.py',312),
  ('primary -> ( expr )','primary',3,'p_expressions','decaf_parser.py',313),
  ('primary -> NEW ID ( arguments )','primary',5,'p_expressions','decaf_parser.py',314),
  ('primary -> NEW ID ( )','primary',4,'p_expressions','decaf_parser.py',315),
  ('primary -> field_access','primary',1,'p_expressions','decaf_parser.py',316),
  ('primary -> method_invocation','primary',1,'p_expressions','decaf_parser.py',317),
  ('arguments -> expr','arguments',1,'p_expressions','decaf_parser.py',318),
  ('arguments -> expr , arguments','arguments',3,'p_expressions','decaf_parser.py',319),
  ('field_access -> primary . ID','field_access',3,'p_expressions','decaf_parser.py',320),
  ('field_access -> ID','field_access',1,'p_expressions','decaf_parser.py',321),
  ('method_invocation -> field_access ( arguments )','method_invocation',4,'p_expressions','decaf_parser.py',322),
  ('method_invocation -> field_access ( )','method_invocation',3,'p_expressions','decaf_parser.py',323),
  ('expr -> primary','expr',1,'p_expressions','decaf_parser.py',324),
  ('expr -> assign','expr',1,'p_expressions','decaf_parser.py',325),
  ('expr -> expr arith_op expr','expr',3,'p_expressions','decaf_parser.py',326),
  ('expr -> expr bool_op expr','expr',3,'p_expressions','decaf_parser.py',327),
  ('expr -> unary_op expr','expr',2,'p_expressions','decaf_parser.py',328),
  ('assign -> field_access ASSIGN expr','assign',3,'p_expressions','decaf_parser.py',329),
  ('assign -> field_access INCREMENT','assign',2,'p_expressions','decaf_parser.py',330),
  ('assign -> INCREMENT field_access','assign',2,'p_expressions','decaf_parser.py',331),
  ('assign -> field_access DECREMENT','assign',2,'p_expressions','decaf_parser.py',332),
  ('assign -> DECREMENT field_access','assign',2,'p_expressions','decaf_parser.py',333),
  ('stmt_expr -> assign','stmt_expr',1,'p_expressions','decaf_parser.py',334),
  ('stmt_expr -> method_invocation','stmt_expr',1,'p_expressions','decaf_parser.py',335),
  ('arith_op -> PLUS','arith_op',1,'p_operators','decaf_parser.py',458),
  ('arith_op -> MINUS','arith_op',1,'p_operators','decaf_parser.py',459),
  ('arith_op -> TIMES','arith_op',1,'p_operators','decaf_parser.py',460),
  ('arith_op -> DIVIDE','arith_op',1,'p_operators','decaf_parser.py',461),
  ('bool_op -> AND','bool_op',1,'p_operators','decaf_parser.py',462),
  ('bool_op -> OR','bool_op',1,'p_operators','decaf_parser.py',463),
  ('bool_op -> EQUALITY','bool_op',1,'p_operators','decaf_parser.py',464),
  ('bool_op -> INEQUALITY','bool_op',1,'p_operators','decaf_parser.py',465),
  ('bool_op -> LESSER','bool_op',1,'p_operators','decaf_parser.py',466),
  ('bool_op -> GREATER','bool_op',1,'p_operators','decaf_parser.py',467),
  ('bool_op -> LEQ','bool_op',1,'p_operators','decaf_parser.py',468),
  ('bool_op -> GEQ','bool_op',1,'p_operators','decaf_parser.py',469),
  ('unary_op -> PLUS','unary_op',1,'p_operators','decaf_parser.py',470),
  ('unary_op -> MINUS','unary_op',1,'p_operators','decaf_parser.py',471),
  ('unary_op -> NOT','unary_op',1,'p_operators','decaf_parser.py',472),
  ('empty -> <empty>','empty',0,'p_empty','decaf_parser.py',486),
>>>>>>> 2dab13bc4198c10d860369c722bea36627fd633e
]
